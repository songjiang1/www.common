...
namespace sys.Dal.Busines.PublicInfoManage
{
    ...
    public class FileFolderBLL
    {
        ...
        /// <returns></returns>
        public IEnumerable<FileFolderEntity> GetList(string userId, string category)
        {
            return service.GetList(userId,category);
        }
        /// <summary>
        /// 文件夹实体
        /// </summary>
        ...
        /// <returns></returns>
        public FileFolderEntity GetEntity(string keyValue, string category = "")
        {
            return service.GetEntity(keyValue, category = "");
        }
        #endregion

using sys.Dal.Busines.PublicInfoManage;
...
namespace sys.Application.Web.Areas.PublicInfoManage.Controllers
{
    ...
    public class ResourceFileController : MvcControllerBase
    {
        ...
        [HttpGet]
        public ActionResult GetTreeJson(string category)
        {
            string userId = OperatorProvider.Provider.Current().UserId;
            var data = fileFolderBLL.GetList(userId,category);
        ...
        [HttpGet]
        public ActionResult GetListJson(string folderId, string category="")
        {
            string userId = OperatorProvider.Provider.Current().UserId;
            var data = fileInfoBLL.GetList(folderId, userId,category);
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult UploadifyFile(string folderId,string category, HttpPostedFileBase file)
        {
            try
            {
                ...
                if (!System.IO.File.Exists(fullFileName))
                {
                    ...
                    fileInfoEntity.Category = category;
